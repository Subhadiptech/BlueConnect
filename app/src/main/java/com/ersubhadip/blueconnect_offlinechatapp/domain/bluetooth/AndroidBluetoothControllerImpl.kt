...
import com.ersubhadip.blueconnect_offlinechatapp.mappers.toByteArray
...
class AndroidBluetoothControllerImpl(
    ...
    private val bluetoothStateReceiver = BluetoothConnectionStateReceiver { isConnected, bluetoothDevice ->
    ...
    override suspend fun trySendMessage(message: String): BluetoothMessage? {
        ...
        val bluetoothMessage = BluetoothMessage(
            message = message,
            sendersName = bluetoothAdapter?.name ?: "Unknown name",
